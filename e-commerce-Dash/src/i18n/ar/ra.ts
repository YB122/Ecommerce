const raMessages = {
  ...
  message: {
    ...
    bulk_update_content: "هل أنت متأكد من تحديث هذه العناصر؟",
    bulk_update_title: "تحديث العناصر",
